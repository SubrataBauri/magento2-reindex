...
namespace Subrata\Reindex\Controller\Adminhtml\Reindex;
...
/**
 * Class Index
 * @package Subrata\Reindex\Controller\Adminhtml\Reindex
 */
class Reindex extends Action
{
    ...
    {
        return $this->_authorization->isAllowed('Subrata_Reindex::reindex');
    }
